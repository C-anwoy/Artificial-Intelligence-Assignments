...
class And(BinaryFormula):
    ...
    def truthValue(self, truthDict):
        ...
        p=self.arg1
        q=self.arg2
        if p.truthValue(truthDict) == False or q.truthValue(truthDict) == False:
            return False
        elif p.truthValue(truthDict) == True and q.truthValue(truthDict) == True:
            return True
...
class Or(BinaryFormula):
    ...
    def toCNF(self):
        ...
        if isinstance(temp1, And):
            p=temp1.arg1
            q=temp1.arg2
            r=Or(p,temp2)
            s=Or(q,temp2)
            return And(r.toCNF(),s.toCNF())
        elif isinstance(temp2, And):
            p=temp2.arg1
            q=temp2.arg2
            r=Or(p,temp1)
            s=Or(q,temp1)
    ...
    def truthValue(self, truthDict):
        ...
        p=self.arg1
        q=self.arg2
        if p.truthValue(truthDict) == True or q.truthValue(truthDict) == True:
            return True
        elif p.truthValue(truthDict) == False and q.truthValue(truthDict) == False:
            return False
...
class Not(Formula):
    ...
    def toCNF(self):
        ...
        if self.arg == TrueConstant:
            ...
            temp=Or(Not(self.arg.arg1),Not(self.arg.arg2))
            return temp.toCNF()
        elif isinstance(self.arg, Or):
            temp=And(Not(self.arg.arg1),Not(self.arg.arg2))
            return temp.toCNF()
        else:
    ...
    def truthValue(self, truthDict):
        ...
        p=self.arg
        if p.truthValue(truthDict) == True:
            return False
        elif p.truthValue(truthDict) == False:
            return True
